@section('meta')
    <title>{{ __('Sticker sections') }} &raquo; {{ $section->name }} &raquo; {{ __('Delete') }} - {{ __('Backend') }} | {{ config('app.name') }}</title>
@endsection
    ...
    <div class="container">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <p class="card-text">{{ __('Removing this sticker section is permanent and cannot be undone. Are you sure?') }}</p>
            </div>
