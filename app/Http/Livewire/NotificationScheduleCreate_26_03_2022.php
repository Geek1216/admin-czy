...
class NotificationScheduleCreate_26_03_2022 extends Component
{
    public $template;
    ...
    public function create()
    {
        ...
        $schedule->save();
        session()->flash('success', __('Notification schedule @ :time has been successfully added.', ['time' => $schedule->time]));
        return redirect()->route('notification-schedules.show', $schedule);
    }
}
