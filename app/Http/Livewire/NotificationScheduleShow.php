...
class NotificationScheduleShow extends Component
{
    public $schedule;
    ...
    public function send()
    {
        ...
        if (empty($template)) {
            flash()->warning(__('Please add at least 1 notification template.'));
        } else {
            ...
            flash()->info(__('Notification will be sent shortly.'));
        }
    }
}
