...
<div>
    <div class="container">
        ...
        <div class="btn-toolbar mb-3">
            <a class="btn btn-outline-dark" href="{{ route('users.show', $user) }}">
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <form class="mb-0" wire:submit.prevent="update">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="user-password">{{ __('Password') }}</label>
                                <div class="col-sm-8">
                                    <input class="form-control @error('password') is-invalid @enderror" id="user-password" type="password" wire:model="password">
                                    @error('password')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            @if (config('fixtures.gifts_enabled'))
                                <div class="form-group row">
                                    <label class="col-sm-4 col-form-label" for="user-balance">{{ __('Balance') }} <span class="text-danger">&ast;</span></label>
                                    <div class="col-sm-8">
                                        <div class="input-group @error('balance') is-invalid @enderror">
                                            <input class="form-control @error('balance') is-invalid @enderror" id="user-balance" required type="number" wire:model="balance">
