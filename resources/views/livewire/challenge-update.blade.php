@section('meta')
    <title>{{ __('Challenges') }} &raquo; {{ $challenge->name }} &raquo; {{ __('Edit') }} - {{ __('Backend') }} | {{ config('app.name') }}</title>
@endsection
    ...
    <div class="container">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <p class="card-text">{{ __('Update existing challenge information here.') }}</p>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <form class="mb-0" wire:submit.prevent="update">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="challenge-image">{{ __('Image') }}</label>
                                <div class="col-sm-8">
                                    <div class="custom-file">
                                        <input class="custom-file-input @error('image') is-invalid @enderror" id="challenge-image" type="file" wire:model="image">
