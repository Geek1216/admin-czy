...
class NotificationScheduleUpdate_26_03_2022 extends Component
{
    public $schedule;
    ...
    public function update()
    {
        ...
        $this->schedule->save();
        session()->flash('info', __('Notification schedule @ :time has been updated.', ['time' => $this->schedule->time]));
        return redirect()->route('notification-schedules.show', $this->schedule);
    }
}
