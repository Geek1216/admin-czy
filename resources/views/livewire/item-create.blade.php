@section('meta')
    <title xmlns:wire="http://www.w3.org/1999/xhtml">{{ __('Items') }} &raquo; {{ __('New') }} - {{ __('Backend') }} | {{ config('app.name') }}</title>
@endsection
    ...
    <div class="container">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <p class="card-text">{{ __('Create a new item.') }}</p>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <form class="mb-0" wire:submit.prevent="create">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="item-image">{{ __('Image') }} <span class="text-danger">&ast;</span></label>
                                <div class="col-sm-8">
                                    <div class="custom-file">
                                        <input class="custom-file-input @error('image') is-invalid @enderror" id="item-image" type="file" required wire:model="image">
