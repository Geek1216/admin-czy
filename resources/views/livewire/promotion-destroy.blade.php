@section('meta')
    <title>{{ __('Promotions') }} &raquo; {{ $promotion->title }} &raquo; {{ __('Delete') }} - {{ __('Backend') }} | {{ config('app.name') }}</title>
@endsection
    ...
    <div class="container">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <p class="card-text">{{ __('Removing this promotion is permanent and cannot be undone. Are you sure?') }}</p>
            </div>
