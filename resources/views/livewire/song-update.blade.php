@section('meta')
    <title>{{ __('Songs') }} &raquo; {{ $song->title }} &raquo; {{ __('Edit') }} - {{ __('Backend') }} | {{ config('app.name') }}</title>
@endsection
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('songs.show', $song) }}">{{ $song->title }}</a></li>
                <li class="breadcrumb-item active" aria-current="page">{{ __('Edit') }}</li>
            </ol>
        </nav>
        <div class="btn-toolbar mb-3">
            <a class="btn btn-outline-dark" href="{{ route('songs.show', $song) }}">
        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <p class="card-text">{{ __('Update existing song information here.') }}</p>
            </div>
                ...
                <div class="row">
                    <div class="col-md-12 col-lg-8">
                        <form class="mb-0" wire:submit.prevent="update">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-4 col-form-label" for="song-audio">{{ __('Main audio') }}</label>
                                <div class="col-sm-8">
                                    <div class="custom-file">
                                        <input class="custom-file-input @error('audio') is-invalid @enderror" id="song-audio" type="file" wire:model="audio">
